...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_timeout__ = __webpack_require__(275);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, alerCtrl, http) {
        this.navCtrl = navCtrl;
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        _this.http.get('https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=zh-CN&dt=t&q=' + datatext)
                            ...
                            _this.doAlert(returnString);
                        }, function (err) {
                            _this.doAlert("Failed");
                            console.log(err);
                        });
